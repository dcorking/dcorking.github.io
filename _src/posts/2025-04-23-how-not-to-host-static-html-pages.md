...
A Heroku dyno is a form of Linux container. When I first
...
Rails web server (which these days is a program called puma). When the
server stops, the dyno goes away.
...
Then one day I became curious. How does it work? What service does the
dyno actually give me? Try hosting a pure HTTP server on Heroku,
instead of a full blown app, and it might give you some idea.
